...
function MobileDiscussionSheet({
  onClose,
  messages,
  sessionId,
  onSend,
  ...
  return (
    <div
      className={`sheet-overlay fixed inset-0 z-[2000] flex flex-col justify-end bg-black/40 backdrop-blur-[2px] md:hidden${leave}`}
      role="presentation"
      onClick={requestClose}
      onAnimationEnd={onExitAnimationEnd}
    >
      <div
        className={`sheet-panel flex max-h-[min(78dvh,560px)] min-h-[45dvh] flex-col rounded-t-[8px] bg-white shadow-2xl dark:bg-slate-900${leave}`}
        role="dialog"
        aria-modal="true"
