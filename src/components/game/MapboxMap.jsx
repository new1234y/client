...
function allyHtml(oob) {
  const border = oob ? "4px solid #ef4444" : "3px solid #fff";
  return `<span style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;border-radius:50%;background:#d97706;border:${border};box-shadow:0 2px 8px rgba(0,0,0,.45)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fef3c7" stroke-width="1.5" stroke-linecap="round"><circle cx="12" cy="13" r="7"/><circle cx="7" cy="6" r="3"/><circle cx="17" cy="6" r="3"/><circle cx="10" cy="12" r="1" fill="#fef3c7" stroke="none"/><circle cx="14" cy="12" r="1" fill="#fef3c7" stroke="none"/></svg></span>`;
}

function catHtml(oob) {
  const border = oob ? "4px solid #ef4444" : "3px solid #fff";
  return `<span style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;border-radius:50%;background:#7f1d1d;border:${border};box-shadow:0 2px 8px rgba(0,0,0,.45)"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fca5a5" stroke-width="1.5" stroke-linecap="round"><path d="M5 9 4 4l4 2a7 7 0 0 1 8 0l4-2-1 5"/><circle cx="9" cy="12" r="1" fill="#fca5a5" stroke="none"/><circle cx="15" cy="12" r="1" fill="#fca5a5" stroke="none"/><path d="M9 16c2 1.5 4 1.5 6 0"/></svg></span>`;
}
