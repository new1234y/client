...
function allyHtml(oob) {
  const border = oob ? "4px solid #ef4444" : "3px solid #fff";
  return `<span style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;border-radius:50%;background:#d97706;border:${border};box-shadow:0 2px 8px rgba(0,0,0,.45)">${roleSvg("mouse")}</span>`;
}

function catHtml(oob) {
  const border = oob ? "4px solid #ef4444" : "3px solid #fff";
  return `<span style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;border-radius:50%;background:#7f1d1d;border:${border};box-shadow:0 2px 8px rgba(0,0,0,.45)">${roleSvg("cat")}</span>`;
}

function preyHtml(oob) {
  const border = oob ? "4px solid #ef4444" : "3px solid #fff";
  return `<span style="display:flex;width:100%;height:100%;align-items:center;justify-content:center;border-radius:50%;background:#ea580c;border:${border};box-shadow:0 2px 8px rgba(0,0,0,.45)">${roleSvg("mouse")}</span>`;
}
